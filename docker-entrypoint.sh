...
OPENAI_MODEL=${OPENAI_MODEL_ID:-minimaxai/minimax-m2.5}
LLM_API_KEY=${OPENAI_API_KEY:-}
LLM_BASE_URL=${OPENAI_API_BASE:-https://api.openai.com/v1}
LLM_MODEL=${OPENAI_MODEL_ID:-minimaxai/minimax-m2.5}
